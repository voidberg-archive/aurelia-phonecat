...
var _phoneListPoJs = require('./phone-list.po.js');

var _phoneDetailsPoJs = require('./phone-details.po.js');

describe('aurelia phonecat app', function () {
  var po_phoneList, po_phoneDetails;

  describe('phone list view', function () {
    beforeEach(function () {
      po_phoneList = new _phoneListPoJs.PageObject_PhoneList();
    ...
    it('should be possible to control phone order via the drop down select box', function () {
      ...
      expect(po_phoneList.getPhoneNames()).toEqual(['MOTOROLA XOOM™', 'Motorola XOOM™ with Wi-Fi']);

      po_phoneList.selectSort('Newest');

      expect(po_phoneList.getPhoneNames()).toEqual(['Motorola XOOM™ with Wi-Fi', 'MOTOROLA XOOM™']);
    });
  ...
  describe('Phone detail view', function () {
    ...
    beforeEach(function () {
      po_phoneDetails = new _phoneDetailsPoJs.PageObject_PhoneDetails();
